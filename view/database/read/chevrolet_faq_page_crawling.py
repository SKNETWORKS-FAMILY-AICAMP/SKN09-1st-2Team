...
faq_categorys = driver.find_elements(By.CSS_SELECTOR,
                                     '#gb-main-content > adv-grid.hide-for-small.hide-for-medium.hide-for-large.none-margin.grid-sm-fw > adv-col.col-sm-12.col-sm-bw-up-2.col-sm-gut-no.col-sm-bs-up-solid.q-cc-ag-lightgray-border > div > adv-grid > adv-col')
...
for faq_category in faq_categorys:
    ...
    print(
        len(faq_elems))  # gb-main-content > gb-adv-grid.gb-small-margin > adv-col > div > div:nth-child(1) > div > div.q-headline.q-expander-button.stat-expand-icon > h3
    for faq_elem in faq_elems:  # gb-main-content > adv-grid.large-margin > adv-col > div > div:nth-child(2) > div > div.q-headline.q-expander-button.stat-expand-icon > h6
        faq_heads_elem1 = faq_elem.find_element(By.CSS_SELECTOR,
                                                "div > div.q-headline.q-expander-button.stat-expand-icon")
