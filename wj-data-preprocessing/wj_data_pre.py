...
for year in year_list:
    data_1 = pd.read_excel('./wj-data-preprocessing/data/'+ year +'년_11월_자동차_등록자료_통계.xlsx', sheet_name='10.연료별_등록현황',skiprows=2)
    if year in year[0:4]:
    ...
    dd.to_csv('./wj-data-preprocessing/send/'+year+'_data.csv', encoding='utf-8')
...
chart_data3.to_csv('./fuel_info.csv', encoding='utf-8')
